...
export type AffiliateLink = { label: string; href: string; vendor?: string };
...
export const TRAVEL_GUIDES: Record<TravelGuideSlug, TravelGuide> = {
  ...
  america: {
    ...
    hotelLinks: [],
    foodNote:
      'Siebkens Resort for classic Wisconsin; the bratwurst situation is taken seriously here.',
    thingsToDo: [
  ...
  ridge: {
    ...
    subtitle:
      'Shelton, Washington. Technical, elevation-heavy, and buried in Pacific Northwest forest.',
    nearestAirports: [
  ...
  laguna: {
    ...
    hotelLinks: [],
    foodNote:
      "Fisherman's Wharf and Cannery Row for the tourist experience; Carmel-by-the-Sea for dinner.",
    thingsToDo: [
  ...
  ohio: {
    ...
    drivingNote:
      'I-71 between Columbus and Cleveland; Lexington is a short detour off the interstate.',
    hotelNote:
      'Mansfield has chain hotels closest to the track. Columbus gives you more restaurants and nightlife.',
    hotelLinks: [],
    thingsToDo: [
  ...
  cota: {
    ...
    drivingNote:
      'Straight down TX-130 or TX-71 from Austin. Race-weekend traffic leaving the track is the pain point.',
    hotelNote:
    ...
    hotelLinks: [],
    foodNote:
      'Franklin Barbecue is worth the line once; many other world-class BBQ spots have shorter waits.',
    thingsToDo: [
