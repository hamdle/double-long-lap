...
// in legacy-next/scripts/output/classes.json. The scrape handles
// engine/weight/age for the rule-driven classes; this file supplies:
//
...
//
// The union of scraped + authored is merged in src/app/data/data.ts (getClassGuide).
